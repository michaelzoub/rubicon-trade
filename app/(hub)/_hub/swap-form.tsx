...
export function SwapForm({ receive, contracts, title = "Trade onchain", onProposed }: {
  ...
  return <section className="hub-swap" aria-labelledby="swap-title">
    ...
    {ready && wallets.length === 0 && <p className="hub-notice">Connect or create a wallet first. Manage wallets on the <a className="hub-inline-link" href="/trade">Trade</a> page.</p>}
