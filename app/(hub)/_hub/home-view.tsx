...
/** Home is the conversation. A short strip of personalized opportunities sits
 * above it only until the conversation has started; afterwards the agent
 * brings opportunities into the thread itself. */
