...
import { CHAINS, DEFAULT_CHAIN } from "@/lib/crypto/chains";
...
export function DepositFunds() {
  ...
  return <div className="hub-deposit">
    {/* Network selector disabled: deposits always use Base.
    ...
    */}
    <p className="socialtrading-caption">Deposit network · Base</p>
