...
export type StateAction =
  ...
  | { action: "agent"; thesis?: string; interests?: HubState["profile"]["interests"]; permission?: HubState["profile"]["permission"]; limits?: HubState["profile"]["limits"]; autoExecute?: boolean }
