...
export function previewHref(href: string): string {
  const views: Record<string, string> = { "/beliefs": "beliefs", "/thesis": "beliefs", "/": "home", "/explore": "explore", "/trade": "explore", "/activity": "activity", "/agents": "agents", "/profile": "profile", "/plans": "plans" };
