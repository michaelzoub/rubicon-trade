...
const tx = { chainId: r.chainId, from: r.wallet, to: ROUTERS[r.chainId], data: '0x1234', value: '0' };
const hash = `0x${'ab'.repeat(32)}`;
let network: string, accounts: string[], native: string;
const provider = { request: vi.fn() };
beforeEach(() => {
  network = '0x2105'; accounts = [r.wallet]; native = '0xde0b6b3a7640000';
